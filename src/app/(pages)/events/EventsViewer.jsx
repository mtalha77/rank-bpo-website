  ...
  const data = [
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            />
            <Image
              src="/images/office/tour-2024/4.jpg"
              alt="startup template"
              width={500}
              height={500}
              className="rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 text-justify">
            Our team enjoyed a lively and memorable annual get-together,
            blending camaraderie with vibrant activities and moments of shared
            joy. The event featured engaging games, insightful discussions, and
            delightful meals that brought everyone closer. It was a wonderful
            opportunity to strengthen bonds and celebrate our achievements
            together.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
            ...
            />
            <Image
              src="/images/office/annual-gathering/4.jpg"
              alt="cards template"
              width={500}
              height={500}
              className="rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 text-justify">
            This 14th August, our office celebrated Pakistan&apos;s Independence Day
            with great enthusiasm and pride. The day was marked by a series of
            events, including a flag-hoisting ceremony, a touching tribute to
